...
✨ Features
Responsive Navigation: A clean, dark-themed navbar with a mobile hamburger menu and video logo integration.
...
Bash
cd cursor-clone
Open in Browser Double-click index.html or use a "Live Server" extension in VS Code.
